...
--
-- Host: localhost
-- Generation Time: Jan 09, 2015 at 09:23 AM
...
INSERT INTO `Usuarios` (`id`, `nombre`, `apellido`, `usuario`, `contrasenia`, `telefono`, `id_agencia`, `email`, `tipo`, `activo`, `direccion`) VALUES
(1, 'jere', 'chaparro', 'jere', '845838210a77ea38b9a662d6f28fd7f3', NULL, 0, NULL, 'admin', 1, NULL);
