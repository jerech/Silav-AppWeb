				...
				<div id="myTabContent" class="tab-content">
					...
					<div class="tab-pane fade" id="password">
						<form id="formulario-contrasenia" name="form" class="form">
							...
							<div class="col-md-4">
								<div class="form-group">
								<label>Password</label><input type="password" id="contrasenia" name="contrasenia" value="" class="form-control">
								</div>
								<input type="hidden" id="contrasenia-encriptada" name="contrasenia-encriptada" class="form-control">		
							</div>
							<div class="col-md-4">
								<div class="form-group">
								<label>Re-Password</label><input type="password" id="re-contrasenia" name="re-contrasenia" value="" class="form-control">
								</div>
