...
<head>
    ...
    <link rel="stylesheet" href="../recursos/plugins/lib/font-awesome/css/font-awesome.css">
	 <link rel="stylesheet" href="../recursos/plugins/lib/jquery.simple-dtpicker.css">
    ...
    <script src="../recursos/plugins/lib/jquery.simple-dtpicker.js" type="text/javascript"></script>
			            ...
			            <div id="widget2container2" class="panel-body collapse in" style=" width: 100%;margin:0 auto;">
			             ...
			             <form id="formulario-pasajes" name="form" class="form">
                            ...
                            <div class="row" >
                                ...
                                <div class="col-md-5" >
                                <div class="form-group">
                    <label>Fecha y Hora del Pedido</label><input type="text" id="fechaYHora" name="fechaYHora" class="form-control">
                    </div>
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="row" >
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <label id="lbl-info-direccion" style="color:#2E64FE;" class="lbl-asignacion"></label>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                            ...
                            <div class="row" >
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>M&oacute;vil</label><input  type="text" readOnly id="movil" name="movil" class="form-control">
                                    </div>
                                </div>
                        ...
                        <!--Fila donde va el boton enviar-->
                            <div class="row" style="text-align:center;">
                                    ...
                                    <div class="btn-toolbar list-toolbar" >
                                        <button id="btnAsignar" name="btnAsignar" class="btn btn-primary" style="width: 100px;">Asignar</button>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                </div>
