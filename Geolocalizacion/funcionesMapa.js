   ...
   function Chofer(nombreChofer, ubicacionLatitud, ubicacionLongitud, estado) {
	...
	function crearMarcador(chofer) {
		if(chofer.estado == "LIBRE"){
			chofer.marcador = new OpenLayers.Marker(chofer.lonLatTransformada, new OpenLayers.Icon(urlDirImagenes+'marker.png',size,offset));
		}
		if(chofer.estado == "OCUPADO"){
			chofer.marcador = new OpenLayers.Marker(chofer.lonLatTransformada, new OpenLayers.Icon(urlDirImagenes+'marker-red.png',size,offset));
		}
		if(chofer.estado == "INACTIVO"){
			chofer.marcador = new OpenLayers.Marker(chofer.lonLatTransformada, new OpenLayers.Icon(urlDirImagenes+'marker-gray.png',size,offset));
		}
	...
	function updateMarkers(){
		...
		for (i=0 ; i<choferesConectados.length ; i++) {
			...
			if(choferesConectados[i].estado == "LIBRE"){
			 	choferesConectados[i].marcador.setUrl(urlDirImagenes+'marker.png');
			
			}
			if(choferesConectados[i].estado == "OCUPADO"){
				choferesConectados[i].marcador.setUrl(urlDirImagenes+'marker-red.png');	
				
			}
			if(choferesConectados[i].estado == "INACTIVO"){
				choferesConectados[i].marcador.setUrl(urlDirImagenes+'marker-gray.png');
