      ...
      $("#btnGuardar").click(function(){
       ...
       $("#btnModificar").click(function(){
		...
		if (typeof($(this).attr('id')) != 'undefined') {
     	...
     	alert(movilesAsignadosModificados.length);
     	if (movilesAsignadosBD.length == 0) {
     		...
     		if (movilesAsignadosModificados.length == 0) {
     			...
     			alert("borrar todos los moviles de la BD");
     		}
     		else {
     		...
     		alert("Agregar: "+movilesParaAgregar.length+"::Eliminar: "+movilesParaEliminar.length);
     	}
